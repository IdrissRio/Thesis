...
\input{papers/jfeature/sec1-introduction.tex}

\section{JFeature: automatic feature extraction}
\label{sec:jfeature}
\input{papers/jfeature/sec2-jfeature.tex}

\section{Corpora Analysis}
\label{sec:corpora}
\input{papers/jfeature/sec3-corpora-analysis.tex}

\section{Extensibility}
\label{sec:extension}
\input{papers/jfeature/sec4-extension.tex}

\section{Use cases for JFeature}
\label{sec:discussion}
\input{papers/jfeature/sec5-discussion.tex}

\section{Related work}
\label{sec:related-works}
\input{papers/jfeature/sec6-related-works.tex}

\section{Conclusions}
\label{sec:conclusions}
\input{papers/jfeature/sec7-conclusions.tex}
