...
In this section, we describe the integration of \textsc{IntraJ} and \textsc{IntraTeal}
...
manner, providing a deeper understanding of the issues detected. It 
allows for real-time interaction with the ASTNode's attributes and the source code, 
enabling analyses developers to explore results and partial results in an easier way, making 
debugging and troubleshooting more efficient with respect the traditional debugging
approaches. The integration of \textsc{IntraJ} and 
Additionally, the integration allows for the visual representation of the results of the
analysis, not only in the form of a warning, but also, e.g., in the form of a graph,
