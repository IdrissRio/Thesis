...
as a declarative approach for implementing dataflow analysis. RAGs 
a powerful and flexible formalism for specifying the syntax and semantics of languages,
and as such, they are widley used in the development of compilers and static analysis tools.
...
Our intention are to exploit the declarative nature of RAGs and 
...
but we encountered some limitations, including the constuction of imprecise control-flow graphs (CFGs).
