...
As can be seen in Figure~\ref{fig:intraJ}, we designed \textsc{IntraJ}
...
construct enhanced control-sensitive CFGs, i.e., it understands that \code{if (x != null){x.f=1}} is safe. Control-sensitive CFGs
