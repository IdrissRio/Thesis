...
The preceding example is a simple instance of an AGs and does not demonstrate all of its expressiveness.
In a real-world scenario, the attribute grammar would be more complex. 
For instance, subtyping and nodes with more than one child of the same type do not appear in this example
but are essential to express, e.g., the semantics of a programming language.
