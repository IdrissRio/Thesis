...
Dynamic analysis involves executing the code and observing its behaviour at runtime.
...
\begin{itemize}
  ...
  observing a program's behaviour during runtime to gather information about its 
  internal state and behaviour.
  % This information can then be used to identify potential bugs or security vulnerabilities.
...
syn boolean Type.compatibleType(Type t){
    ...
    attributed and it can be used in the definition of other attributes. In \textsc{JastAdd}, HOAs
