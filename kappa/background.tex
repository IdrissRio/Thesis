...
In such cases, constructing the control-flow graph on the source level
...
The concrete and the abstract syntax of TEAL-0 are shown in Figure~\ref{fig:tealGrammar}\todo{Don't look at the colors of the abstract grammar. This can be fixed}.
...
Another key feature of \textsc{JastAdd}  is the support of intertype declarations for the definition of attributes.
