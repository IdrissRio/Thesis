...
The previous example only presents a straightforward instance of Attribute Grammars 
and does not display its full expressiveness. In real-life scenarios, Attribute Grammars 
tend to be more complex. Features, such as subtyping and nodes with multiple 
children of the same type which play an important role in expressing the semantics of 
