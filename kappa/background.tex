...
There are two main approaches to constructing the control-flow graph (CFG) for a program:
...
We will use TEAL-0 to demonstrate the use of RAGs and the main results summarized in this thesis.
