...
Static analysis is a technique for automatically analysing the behaviour of software
...
Control-flow analysis involves analysing the control flow of a program,
...
infinite loops.
Dataflow analysis, on the other hand, involves analysing the flow of data through
...
the full behaviour of a program, particularly in cases involving complex
interactions or data-dependent behaviour.
