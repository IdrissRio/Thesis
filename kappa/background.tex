...
if-else statement. The program may crash if \code{x} is \code{null}. 
Indeed, this information can be used to identify potential bugs in the program, such as,
unexpected \code{NullPointerException}, ahead of time.
...
\todo{idriss: I would move the reference to Fors et al here.}
