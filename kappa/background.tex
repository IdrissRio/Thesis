...
not even be possible due to the loss of information during the translation process, e.g., \code{source-file retention} for Java annotations. 
...
graphs of the simple method \texttt{foo}.
\begin{figure}[h]
  \centering
\begin{tabular}{l r}
