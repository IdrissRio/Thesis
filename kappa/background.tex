...
\begin{align*}
  &\astnode{A}.\textcolor{ATGsym}{\mSyn{}\umlcode{z}} = \astnode{A}.\astnode{B}.\textcolor{ATGsym}{\mSyn{}\umlcode{x}} + 2 \\
  &\astnode{A}.\astnode{B}.\textcolor{ATGsym}{\mSyn{}\umlcode{x}} = \astnode{A}.\astnode{B}.\textcolor{ATGsym}{\mInh{}\umlcode{w}} - 1 \\
  &\astnode{A}.\astnode{C}.\astnode{B}.\textcolor{ATGsym}{\mSyn{}\umlcode{x}} = \astnode{A}.\astnode{C}.\astnode{B}.\textcolor{ATGsym}{\mInh{}\umlcode{w}} - 1 \\ 
  &\astnode{A}.\astnode{C}.\textcolor{ATGsym}{\mSyn{}\umlcode{v}} = \astnode{A}.\astnode{C}.\astnode{B}.\textcolor{ATGsym}{\mInh{}\umlcode{w}} \\
  &\astnode{A}.\astnode{B}.\textcolor{ATGsym}{\mInh{}\umlcode{w}} = 36 \\
  &\astnode{A}.\astnode{C}.\astnode{B}.\textcolor{ATGsym}{\mInh{}\umlcode{w}} = 5 \\
  &\astnode{A}.\astnode{C}.\textcolor{ATGsym}{\mInh{}\umlcode{y}} = \astnode{A}.\textcolor{ATGsym}{\mSyn{}\umlcode{z}} + \astnode{A}.\astnode{C}.\textcolor{ATGsym}{\mSyn{}\umlcode{v}} \\
\end{align*}
Solving the equation system for the attribute \Asyn{A}{z} gives:
\begin{align*}
  \astnode{A}.\textcolor{ATGsym}{\mSyn{}\umlcode{z}} =& \astnode{A}.\astnode{B}.\textcolor{ATGsym}{\mSyn{}\umlcode{x}} + 2 \\
  =& (\astnode{A}.\astnode{B}.\textcolor{ATGsym}{\mInh{}\umlcode{w}} - 1) + 2 \\
  =& (36 - 1) + 2 \\
  =& 37
\end{align*}
Solving for  \Ainh{C}{y}, resuing the solved value for \Asyn{A}{z}, gives:
\begin{align*}
  \astnode{A}.\astnode{C}.\textcolor{ATGsym}{\mInh{}\umlcode{y}} = & \astnode{A}.\textcolor{ATGsym}{\mSyn{}\umlcode{z}} + \astnode{A}.\astnode{C}.\textcolor{ATGsym}{\mSyn{}\umlcode{v}} \\
  = & 37 + \astnode{A}.\astnode{C}.\textcolor{ATGsym}{\mSyn{}\umlcode{v}} \\
  = & 37 + \astnode{A}.\astnode{C}.\astnode{B}.\textcolor{ATGsym}{\mInh{}\umlcode{w}} \\
  = & 37 + 5 \\
  = & 42
\end{align*}
