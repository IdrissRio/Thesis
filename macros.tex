...
\newcommand{\Asynno}[2]{\textcolor{ATGsym}{\mbox{\mSyn{}\umlcode{#2}}}} % Ignoring the astnode. 
...
\newcommand{\Ainhno}[2]{\textcolor{ATGsym}{\mbox{\mInh{}\umlcode{#2}}}} % Ignoring the astnode.
...
\newcommand{\AcircSyn}[2]{\textcolor{ATGsym}{\mbox{\umlcode{\astnode{#1}}.\mCirc{}\mSyn{}\umlcode{#2}}}}
...
\lstdefinelanguage{JastAdd}{
  ...
  %keyword4
  morekeywords = [3]{AddExpr,CFGNode,ControlTrue, A, B, C ,Assignments, Program,Assign,AssignBitwiseExpr, TrueLiteral, Entry,ConstructorDecl,UnceckedException, TryWithResorucesStmt, NTAFinallyBlock,ClassDecl, CloseListNTA, BreakStmt,ThrowStmt,TryStmt,ReturnStmt, ContinueStmt, Exit, Expr, AssignShiftExpr, AssignMultiplicativeExpr, Type,IntegerLiteral, AssignAdditiveExpr, UnaryIncDec,DoStmt,VariableDeclarator, NumericLiteral, ParameterDeclaration, FieldDeclarator, PostfixExpr, PreIncExpr, PreDecExpr, ReachedLVal, Variable,EQOp,CFGSupport, ForStmt, EmptyStmt,FunDecl, MethodDecl, ExprStmt, AssignStmt, IfStmt, AndOp, LessOp, WhileStmt, Block, AssignExpr, PostUnaryInc, PostUnaryDec, Entry, Exit, EQExpr, VarAccess, CFGRoot }, %ASTnode typess
  %keyword5
  morekeywords = [4]{void,Array,NullDomain, ArrayList, Boolean, Byte, Object, BitSet, BufferedReader,Collections, Character, Class, Double, Float, Gamma, AbsDomain, NULL, NOTNULL, TOP,Integer, HashMap, PrintWriter, String, StringBuffer, StringBuilder, Thread, boolean, byte, char, color, double, float, int, long, short, FloatDict, FloatList, IntDict, IntList, JSONArray, JSONObject, PFont, PGraphics, PImage, PShader, PShape, PVector, StringDict, StringList, Table, TableRow, XML, Set, HashSet},
...
\newcommand{\nativetype}[1]{\ensuremath{\textcolor{lightblue}{\text{#1}}}}
...
\lstdefinelanguage{ASTGrammar}{
  ...
  morekeywords = [6]{DeclTy, Initializer, DeclRetTy, Formal, Body, Left, Right, Base, Index, DeclType, Value, LValue, RValue, Cond, Then, Else},
...
pp. 1--11}. Virtual, 2021. DOI: \href{https://doi.org/10.1109/SCAM52516.2021.00009}{10.1109/SCAM52516.2021.00009}.

An artifact, including the source code and evaluation results, was submitted for 
the paper at the ROSE (\textbf{R}ecognizing and Rewarding \textbf{O}pen Science in \textbf{SE}) festival and awarded with the badges ``\emph{Open Research Objects}'' \includegraphics[height=10pt]{kappa/img/Open_Research.png} and ``\emph{Research Objects Reviewed}''\includegraphics[height=10pt]{kappa/img/Research_Objects.png}.\\
...
In \emph{22nd International Working Conference on Source Code Analysis and Manipulation (SCAM),
pp. 236--241s}. Limassol, Cyprus, 2022. DOI: \href{https://doi.org/10.1109/SCAM55253.2022.00033}{10.1109/SCAM55253.2022.00033}.

An artifact, including the source code and evaluation results, was submitted for 
the paper at the ROSE (\textbf{R}ecognizing and Rewarding \textbf{O}pen Science in \textbf{SE}) festival and awarded with the badges ``\emph{Open Research Objects}'' \includegraphics[height=10pt]{kappa/img/Open_Research.png}.\\
DOI: \href{https://doi.org/10.5281/zenodo.7053768}{10.5281/zenodo.7053768}.
}
